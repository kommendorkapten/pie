...
extern int      pie_mountpoint_create(sqlite3 * db, struct pie_mountpoint * this);
extern int      pie_mountpoint_read(sqlite3 * db, struct pie_mountpoint * this);
extern int      pie_mountpoint_update(sqlite3 * db, struct pie_mountpoint * this);
extern int      pie_mountpoint_delete(sqlite3 * db, struct pie_mountpoint * this);
