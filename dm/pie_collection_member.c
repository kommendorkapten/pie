...
{
	char           *q = "SELECT cmb_col_id FROM pie_collection_member WHERE cmb_col_id = ? AND cmb_mob_id = ?";
	sqlite3_stmt   *pstmt;
	int             ret;
	int             retf;
...
int pie_collection_member_delete_mob(sqlite3 * db, long mob_id)
{
	char           *q = "DELETE FROM pie_collection_member WHERE cmb_mob_id = ?";
	sqlite3_stmt   *pstmt;
	int             ret;
	int             retf;
